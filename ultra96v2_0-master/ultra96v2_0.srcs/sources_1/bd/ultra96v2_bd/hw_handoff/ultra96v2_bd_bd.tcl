...
################################################################
# This is a generated script based on design: ultra96v2_bd
#
...
# source ultra96v2_bd_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# bus_to_axis, cvt_offset_binary
...
proc create_hier_cell_CPU { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 FAN_PWM


  # Create pins
  create_bd_pin -dir I BT_HCI_CTS
  create_bd_pin -dir O BT_HCI_RTS
  create_bd_pin -dir O -from 15 -to 0 HD_GPIO
  ...
  set_property -dict [ list \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {101.375} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {8.250} \
   CONFIG.MMCM_DIVCLK_DIVIDE {10} \
 ] $clk_wiz_0

  # Create instance: fan_pwm, and set properties
  set fan_pwm [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 fan_pwm ]
  set_property -dict [ list \
   CONFIG.C_GPIO_WIDTH {1} \
 ] $fan_pwm

  # Create instance: hd_gpio, and set properties
  set hd_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 hd_gpio ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net fan_pwm_GPIO [get_bd_intf_pins FAN_PWM] [get_bd_intf_pins fan_pwm/GPIO]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins hd_gpio/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins fan_pwm/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins clk_out1] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net axi_uart16550_0_rtsn [get_bd_pins BT_HCI_RTS] [get_bd_pins axi_uart16550_0/rtsn]
  connect_bd_net -net ctsn_0_1 [get_bd_pins BT_HCI_CTS] [get_bd_pins axi_uart16550_0/ctsn]
  connect_bd_net -net hd_gpio_gpio_io_o [get_bd_pins hd_gpio/gpio_io_o] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins fan_pwm/s_axi_aresetn] [get_bd_pins hd_gpio/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins HD_GPIO] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlconcat_0/In1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins fan_pwm/s_axi_aclk] [get_bd_pins hd_gpio/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
...
proc create_root_design { parentCell } {
  ...
  set HD_GPIO [ create_bd_port -dir O -from 7 -to 0 HD_GPIO ]
  ...
  set_property USER_COMMENTS.comment_4 "split to separate I, Q streams" [get_bd_cells /axis_broadcaster_0]
  set_property -dict [ list \
   CONFIG.M00_TDATA_REMAP {tdata[23:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[47:24]} \
   CONFIG.M02_TDATA_REMAP {tdata[23:0]} \
  ...
  set_property USER_COMMENTS.comment_6 "merge to one I/Q stream" [get_bd_cells /axis_combiner_0]
  set_property -dict [ list \
  ...
  # Create instance: bus_to_axis_0, and set properties
  set block_name bus_to_axis
  set block_cell_name bus_to_axis_0
  if { [catch {set bus_to_axis_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bus_to_axis_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.DIN_WIDTH {32} \
   CONFIG.VALIDONCHANGEONLY {0} \
 ] $bus_to_axis_0
  ...
  set_property USER_COMMENTS.comment_5 "separate I, Q CIC filters" [get_bd_cells /cic_compiler_0]
  set_property -dict [ list \
   CONFIG.Clock_Frequency {122.88} \
   CONFIG.Fixed_Or_Initial_Rate {320} \
   CONFIG.HAS_ARESETN {true} \
   CONFIG.HAS_DOUT_TREADY {false} \
   CONFIG.Input_Data_Width {20} \
   CONFIG.Input_Sample_Frequency {0.384} \
   CONFIG.Maximum_Rate {320} \
   CONFIG.Minimum_Rate {320} \
  ...
  set_property USER_COMMENTS.comment_2 "Mixer" [get_bd_cells /cmpy_0]
  set_property -dict [ list \
  ...
  set_property USER_COMMENTS.comment_1 "VFO Oscillator" [get_bd_cells /dds_compiler_0]
  set_property -dict [ list \
  ...
  set_property USER_COMMENTS.comment_0 "simulates the I/Q modulation" [get_bd_cells /dds_compiler_1]
  set_property -dict [ list \
   ...
   CONFIG.Output_Width {16} \
   CONFIG.PINC1 {110101010101010} \
   CONFIG.Phase_Width {17} \
   CONFIG.Spurious_Free_Dynamic_Range {96} \
 ] $dds_compiler_1

  # Create instance: fir_compiler_0, and set properties
  set fir_compiler_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:fir_compiler:7.2 fir_compiler_0 ]
  set_property USER_COMMENTS.comment_3 "I/Q filter" [get_bd_cells /fir_compiler_0]
  set_property -dict [ list \
   CONFIG.BestPrecision {true} \
   CONFIG.Clock_Frequency {122.88} \
   CONFIG.CoefficientSource {COE_File} \
   CONFIG.Coefficient_File {../../../../../../../FIR filter coefficients.coe} \
   CONFIG.Coefficient_Fractional_Bits {25} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins cic_compiler_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins cic_compiler_1/S_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_1_M_AXIS [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins axis_dwidth_converter_1/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dds_compiler_1_M_AXIS_DATA [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins dds_compiler_1/M_AXIS_DATA]
  connect_bd_intf_net -intf_net fan_pwm_GPIO [get_bd_intf_ports FAN_PWM] [get_bd_intf_pins CPU/FAN_PWM]
  ...
  # Create port connections
  connect_bd_net -net aclk_1 [get_bd_pins CPU/clk_out1] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins bus_to_axis_0/aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins cic_compiler_1/aclk] [get_bd_pins cmpy_0/aclk] [get_bd_pins cvt_offset_binary_0/clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins fir_compiler_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins CPU/peripheral_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins bus_to_axis_0/aresetn] [get_bd_pins cic_compiler_0/aresetn] [get_bd_pins cic_compiler_1/aresetn] [get_bd_pins cmpy_0/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_compiler_0/aresetn]
  connect_bd_net -net axi_uart16550_0_rtsn [get_bd_ports BT_HCI_RTS] [get_bd_pins CPU/BT_HCI_RTS]
  connect_bd_net -net bus_to_axis_0_m_axis_tdata [get_bd_pins bus_to_axis_0/m_axis_tdata] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
  connect_bd_net -net bus_to_axis_0_m_axis_tvalid [get_bd_pins bus_to_axis_0/m_axis_tvalid] [get_bd_pins dds_compiler_0/s_axis_phase_tvalid]
  connect_bd_net -net cmpy_0_m_axis_dout_tdata [get_bd_pins cmpy_0/m_axis_dout_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net ctsn_0_1 [get_bd_ports BT_HCI_CTS] [get_bd_pins CPU/BT_HCI_CTS]
  connect_bd_net -net cvt_offset_binary_0_dout [get_bd_ports HD_GPIO] [get_bd_pins cvt_offset_binary_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins bus_to_axis_0/data_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins cvt_offset_binary_0/din] [get_bd_pins xlslice_3/Dout]

  # Create address segments
  assign_bd_address -offset 0xA0020000 -range 0x00002000 -target_address_space [get_bd_addr_spaces CPU/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs CPU/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CPU/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs CPU/axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CPU/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs CPU/fan_pwm/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CPU/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs CPU/hd_gpio/S_AXI/Reg] -force
