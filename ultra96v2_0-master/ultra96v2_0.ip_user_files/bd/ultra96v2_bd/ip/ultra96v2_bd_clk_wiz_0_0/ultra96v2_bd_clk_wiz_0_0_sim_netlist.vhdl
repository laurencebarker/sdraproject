...
-- Date        : Sun May 10 23:14:26 2020
-- Host        : Loz-Inspiron running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/xilinxdesigns/sdraproject/ultra96v2_0-master/ultra96v2_0.srcs/sources_1/bd/ultra96v2_bd/ip/ultra96v2_bd_clk_wiz_0_0/ultra96v2_bd_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : ultra96v2_bd_clk_wiz_0_0
...
entity ultra96v2_bd_clk_wiz_0_0_ultra96v2_bd_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of ultra96v2_bd_clk_wiz_0_0_ultra96v2_bd_clk_wiz_0_0_clk_wiz : entity is "ultra96v2_bd_clk_wiz_0_0_clk_wiz";
end ultra96v2_bd_clk_wiz_0_0_ultra96v2_bd_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of ultra96v2_bd_clk_wiz_0_0_ultra96v2_bd_clk_wiz_0_0_clk_wiz is
  signal clk_in1_ultra96v2_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ultra96v2_bd_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_ultra96v2_bd_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_ultra96v2_bd_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_ultra96v2_bd_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_ultra96v2_bd_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ultra96v2_bd_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of ultra96v2_bd_clk_wiz_0_0 : entity is true;
end ultra96v2_bd_clk_wiz_0_0;

architecture STRUCTURE of ultra96v2_bd_clk_wiz_0_0 is
begin
inst: entity work.ultra96v2_bd_clk_wiz_0_0_ultra96v2_bd_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
