...
HD_PWD='C:/xilinxdesigns/sdraproject/ultra96v2_0-master/ultra96v2_0.runs/ultra96v2_bd_bus_to_axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra96v2_bd_bus_to_axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra96v2_bd_bus_to_axis_0_0.tcl
